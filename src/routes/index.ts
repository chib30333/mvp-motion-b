...
import citiesRoutes from "../modules/cities/cities.routes.ts";
...
import promotionsRoutes from "../modules/promotions/promotions.routes.ts";
...
router.use("/manager/users", usersRoutes);
